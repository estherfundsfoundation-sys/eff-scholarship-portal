...
values
  ('national','Call 211 for local essentials','211','basic_needs','US','Find locally available food, housing, transportation, utility, and crisis-support services. Availability varies by community.','https://www.211.org/','verified_open','official_provider','https://www.211.org/',now(),now()+interval '30 days','national|211|basic-needs'),
  ('national','988 Suicide & Crisis Lifeline','U.S. Department of Health and Human Services','mental_health','US','Call, text, or chat 988 for confidential crisis support in the United States. Call 911 for immediate danger.','https://988lifeline.org/','verified_open','government','https://988lifeline.org/',now(),now()+interval '30 days','national|988|mental-health'),
  ('national','Federal Student Aid help','U.S. Department of Education','financial_aid','US','Official FAFSA, federal student-aid, repayment, and account guidance.','https://studentaid.gov/','verified_open','government','https://studentaid.gov/',now(),now()+interval '30 days','national|studentaid|financial-aid'),
  ('national','Benefits.gov benefit finder','U.S. Government','public_benefits','US','Screen for government benefit programs. Results are guidance; the administering agency makes the eligibility decision.','https://www.benefits.gov/benefit-finder','verified_open','government','https://www.benefits.gov/benefit-finder',now(),now()+interval '30 days','national|benefits-gov|public-benefits'),
  ('national','HUD rental help by state','U.S. Department of Housing and Urban Development','housing','US','Official state-by-state rental assistance, tenant rights, and housing-counseling routes.','https://www.hud.gov/states','verified_open','government','https://www.hud.gov/states',now(),now()+interval '30 days','national|hud-states|housing')
