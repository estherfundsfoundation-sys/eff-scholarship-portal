...
export default function FinishLinePage(){return <main>
  ...
  <section className="section finish-line-close"><div className="shell resource-support"><div><div className="eyebrow">Need a person to review the next step?</div><h2>EFF can help you organize the request.</h2><p>Send your school, exact deadline, the page or office involved, what you already tried, and a redacted screenshot when relevant. Do not email private account credentials or full financial records.</p><div className="hero-actions"><a className="button" href="/help-desk">Open the National Help Desk</a><Link className="button outline" href="/resources">See all student resources</Link></div></div><aside className="finish-line-contact"><strong>Questions</strong><a href="/help-desk">National Help Desk</a><small>EFF provides general educational support, not legal, tax, or financial advice.</small></aside></div></section>
</main>}
