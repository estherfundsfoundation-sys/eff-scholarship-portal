...
function renderMessage(templateKey: string, payload: EmailPayload) {
  ...
  if(templateKey==="futurelink_verified")return{subject:"Your EFF FutureLink profile is verified",html:`<p>Hello ${name},</p><h1 style="color:#42127f">You are eligible for FutureLink matching.</h1><p>Your verification was approved. The automatic matcher will now look for a compatible connection. A proposal is not active until both people accept and sign the mentorship agreement.</p>${button}`};
