  ...
  return <main className="section white"><div className="shell" style={{maxWidth:860}}>
    <div className="case-submitted-confirmation">
      ...
      <div>
        ...
        <h2>Welcome, {name}!</h2>
        <p>Your application was accepted and your secure ambassador record is ready using the account email you chose.</p>
        {query.sent === "1"
    ...
    <div className="cards" style={{marginTop:28}}>
      <div className="card"><ShieldCheck/><h3>Claim your account</h3><p>Use your selected REACH account email: <strong>{email}</strong>.</p><Link className="button" href="/sign-up?next=%2Freach%2Fclaim">Create my account</Link></div>
