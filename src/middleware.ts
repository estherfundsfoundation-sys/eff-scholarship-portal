...
export async function middleware(request: NextRequest) {
  ...
  const protectedPath = ["/dashboard","/profile","/applications","/admin","/careers/dashboard","/careers/profile","/careers/applications","/careers/apply","/careers/board-onboarding"].some(path=>request.nextUrl.pathname.startsWith(path));
